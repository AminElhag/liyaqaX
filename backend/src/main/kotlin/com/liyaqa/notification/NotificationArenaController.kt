...
@RestController
@RequestMapping("/api/v1/arena/notifications")
@Tag(name = "Notifications (Arena)", description = "Member notifications")
@Validated
class NotificationArenaController(
    private val notificationService: NotificationService,
) {
    @GetMapping
    @Operation(summary = "List notifications for the current member")
    fun list(
